<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{ route('admin.contact.index') }}"><i class="fa fa-phone"></i> <span>Quản lý Liên Hệ</span></a>            </li>
            <li><a href="{{ route('admin.user.index') }}"><i class="fa fa-user"></i><span>Quản lý người dùng</span></a></li>
