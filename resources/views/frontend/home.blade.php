                            ...
                            <div class="item-slick2 col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        ...
                                        <a href="{{ route('home.product', ['slug' => $product->slug , 'id' => $product->id]) }}"
                                           title="{{ $product->name }}">
                                            <img width="180" height="250" src="{{asset($product->image)}}"
                                                 alt="{{$product->name}}">
                                        </a>
                            ...
                            @if(!empty($articles))
                                @foreach($articles as $article)
                                    <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                                        <!-- Block3 -->
                                        <div class="block3">
                                            <a href="{{route('home.article.detail' , ['slug' => $article->slug , 'id' => $article->id])}}"
									...
									<span>
                                        By Admin<span class="m-l-3 m-r-6">|</span>
									</span>
